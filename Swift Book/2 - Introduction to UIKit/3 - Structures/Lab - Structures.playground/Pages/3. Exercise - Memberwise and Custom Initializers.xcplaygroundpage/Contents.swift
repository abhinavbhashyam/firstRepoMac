...
print("My favorite book is \(favoriteBook.title), written by \(favoriteBook.author), pages of \(favoriteBook.pages) and a price of \(favoriteBook.price)")
...
let oneHeight = Height(heightInInches: 65)

print(oneHeight.heightInInches)
print(oneHeight.heightInCentimeters)
...
var myHeight = Height(heightInInches: 5)
