...
var abhi = User(name: "Abhi", age: 17, height: 54, weight: 56, activityLevel: 3)

print("My name is \(abhi.name), my age is \(abhi.age), my height is \(abhi.height), my weight is \(abhi.weight), and my activity level is \(abhi.activityLevel)")
